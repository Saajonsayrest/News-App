...
import com.example.newsapp.main.NewsApplication
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> breakingNews.postValue(Resource.Error("Conversion ErrorS"))
            }
        }
    }
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> searchNews.postValue(Resource.Error("Conversion ErrorS"))
            }
        }
    }
